...
C     MKS SYSTEM OF UNITS (J, M, KG, S, C, K, PA)
     ...
     & INTENT(IN) :: S_INSTAR1
      ...
      DIMENSION E_BABY1(24),E_H(24),E_HPUP(24),ECTOINPUT(132)
      DIMENSION ECTOINPUT1(132),ED(24),EGGSHSOI(25),EGGSOIL(25)
      ...
      COMMON/BURROW/SHDBURROW,BURROWSHADE,BURROWBHV
...
233     CONTINUE
     ...
     &     (SUM(ACTHR).EQ.0)))THEN ! NO ACTIVITY YET FOR THE DAY
         ...
         IF(BURROWSHADE.EQ.1)THEN
          SHADE=MAXSHD
          CALL SELDEP(TSHSOI,HSHSOI,ZSOIL,RELHUM,BURROWBHV)
         ELSE
          SHADE=REFSHD
          CALL SELDEP(TSOIL,HSOIL,ZSOIL,RELHUM,BURROWBHV)
         ENDIF
