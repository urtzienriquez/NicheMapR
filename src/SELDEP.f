...
C     NEED NON, # OF SOIL NODES,
      COMMON/BUR/NON,MINNODE,BURROWBHV1
...
C     normal behavior in NicheMapR
      BURROWBHV1 = BURROWBHV
C     normal behavior in NicheMapR
       IF(BURROWBHV1.EQ.0)THEN
