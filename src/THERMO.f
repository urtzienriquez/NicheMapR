...
C     COOLER TEMPERATURES AND HIGHER WIND SPEEDS.
      ...
      DOUBLE PRECISION DEPSUB,DEPTH,DSHD,EMISAN,EMISSB,EMISSK,EXTREF,F12
      DOUBLE PRECISION F13,F14,F15,F16,F21,F23,F24,F25,F26,F31,F32,F41
      DOUBLE PRECISION F42,F51,F52,F61,FATOBJ,FATOSB,FATOSK,FLSHCOND
      DOUBLE PRECISION FLUID,FLYMETAB,FLYSPEED,FLYTIME,FOODLIM,G,GUTFILL
      DOUBLE PRECISION GUTFULL,HRN,HSHSOI,HSOIL,MAXSHD,MR_1,MR_2,MR_3
      DOUBLE PRECISION MSHSOI,MSOIL,NEWDEP,PDIF,PHI,PHIMAX
     ...
     & SKINT,HC,CONVAR,PMOUTH,PANT,PANTMAX
      ...
      INTEGER NODNUM,NON,POSTUR,SHDBURROW,WINGCALC,WINGMOD,BURROWTMP
      INTEGER BURROWWTR
